...
#                  var.lambda_architecture in infra/terraform/batch.
...
mkdir -p "$BUNDLE_DIR/prod/shared_infra"
...
: > "$BUNDLE_DIR/prod/shared_infra/__init__.py"
...
cp "$REPO_ROOT/prod/shared_infra/task_queues.py" "$BUNDLE_DIR/prod/shared_infra/task_queues.py"
cp "$REPO_ROOT/shared/temporal_client.py"        "$BUNDLE_DIR/shared/temporal_client.py"
