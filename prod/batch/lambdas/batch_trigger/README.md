...
```
prod/batch/lambdas/batch_trigger/
...
| `shared.temporal.task_queues`         | `CPU_TASK_QUEUE`, execution timeout const  |
| `shared.temporal.client`              | `connect_temporal` (pydantic data converter) |
...
prod/batch/lambdas/batch_trigger/build.sh    # LAMBDA_ARCH=arm64 by default
